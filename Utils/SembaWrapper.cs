...
public class SembaWrapper {
    ...
    public static ResType? Call<ResType, ReqType>(string path, ReqType request) {
        ...
        var reqJsonUtf8 = Marshal.StringToCoTaskMemUTF8(JsonSerializer.Serialize(request));
        ...
        return (resJson != null) ? JsonSerializer.Deserialize<ResType>(resJson) : default(ResType);
    }
}